...
@Component
@Slf4j
public class SparkOsmNodeSerialization {
    ...
    public Osm deserializeToOsm(File file) {
        ...
        sparkSession
            ...
            .withColumn("pt", concat(lit("POINT("), col("_lon"), lit(" "), col("_lat"), lit(")")))
            .withColumnRenamed("_id", "osm_id")
            .drop("_changeset", "_timestamp", "_user", "_version", "_uid")
            .write()
            .mode(SaveMode.Overwrite)
            .format("avro")
            .save("/home/jim/eclipse-workspace/net.ljcomputing/jxosm/out/nodes.avro")
            ;
    ...
    public void printAvro() {
        Dataset<Row> inDf = sparkSession.read().format("avro")
                .load("/home/jim/eclipse-workspace/net.ljcomputing/jxosm/out/nodes.avro")
